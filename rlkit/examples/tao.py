...
from rlkit.torch.sac.tao import (
    TaoTrainer
)
...
def experiment(variant, args):
    ...
    prior_weight = MLP(obs_dim, args.ensemble_size + 1).to(ptu.device)
    ...
    prior_policy = ParallelTanhGaussianPolicy(policies.copy(), qf1).to(ptu.device)
